...
.then (res => {
        ...
        if(res.ok) {
            res.json().then(data => {
                ...
                const forecast1 = (Math.trunc(data.list[8].main.temp) - 273);
                const forecast2 = (Math.trunc(data.list[16].main.temp) - 273);
                const forecast3 = (Math.trunc(data.list[24].main.temp) - 273);
                const forecast4 = (Math.trunc(data.list[32].main.temp) - 273);
                const forecast5 = (Math.trunc(data.list[38].main.temp) - 273);
